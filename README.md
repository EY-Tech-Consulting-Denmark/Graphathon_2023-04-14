...
All the preprocessing steps  (no need to re-run them) happens in [DataPreparation notebook]().   
...
Open [DataToGraph.ipynb]() and set up the configuration of your local database.  
...
4. Start with exploring the dataset and practising cypher in Neo4j desktop with [Cypher_exercises.md](). 

5. Continue with practising graph algorithms with [Algorithms.ipynb](). Remember to set up the connection to your database again.  
